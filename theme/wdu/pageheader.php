...
<title><?php echo $wudu_seoname;?></title>
...
<link rel="stylesheet" type="text/css" href="<?php echo $wudu_domain;?>theme/wudu3.0/asset/css/style.css?v=3.1.9"/>
<link rel="stylesheet" type="text/css" href="<?php echo $wudu_domain;?>theme/wudu3.0/asset/css/theme.css"/>
<script src="https://lib.baomitu.com/jquery/3.3.1/jquery.min.js"></script>

<script type='text/javascript' src="https://cdn.berryapi.net/wudu/2.0/js/LazyLoad.js"></script>
<script type='text/javascript' src="https://cdn.berryapi.net/wudu/2.0/js/swiper.min.js"></script>
...
<div class="wdu-head-info wdu-back-whits wdu-min-width wdu-box-shadow">
	<div class="wdu-part-case">
		<div class="wdu-navs-left">
			<a class="wdu-navs-logo" href="/" style="margin-top: 10px;font-size: 20px;font-weight: 400;width: auto;">雾都TV</a>
			<a class="wdu-navs-title wdu-font-xvi wdu-text-green wdu-hide wdu-show-md-block" href="./">首页</a>
		...
		<div class="wdu-navs-search wdu-back-whits wdu-hidden wdu-conceal wdu-show-sm-block">
			<a class="wdu-navs-close wdu-conceal wdu-hide-sm" href="javascript:;">取消</a>
			<form class="wdu-navs-form" data-vod="/index.php/vod/search.html" data-art="/index.php/art/search.html" autocomplete="off" onkeydown="if(event.keyCode==13){return false}">
				<input class="wdu-navs-input wdu-back-ashen wdu-event" type="search" placeholder="请输入关键字"/><a class="wdu-navs-submit wdu-back-ashen"><i class="wdu-icon-font wdu-icon-sousuo"></i></a>
			</form>
		</div>
		<div class="wdu-navs-right">
			...
			<a class="wdu-navs-wechat wdu-text-black wdu-event wdu-hide-sm wdu-icon-font wdu-icon-lishi"></a><a class="wdu-navs-code wdu-text-black wdu-event"  href="javascript:;">公众号+</a>
		</div>
		<div class="wdu-pops-navbar wdu-box-shadow wdu-min-width wdu-hidden wdu-conceal wdu-anim" id="wdu-pops-navbar">
			...
			<ul class="wdu-pops-list wdu-font-size wdu-back-whits wdu-part-rows">
				...
				<li class="wdu-col-sm2"><a class="wdu-part-eone" href="<?php echo $wudu_domain;?>">如懿传</a></li>
				<li class="wdu-col-sm2"><a class="wdu-part-eone" href="<?php echo $wudu_domain;?>movie.html">电影</a></li>
				<li class="wdu-col-sm2 wdu-this"><a class="wdu-part-eone" href="<?php echo $wudu_domain;?>">连续剧</a></li>
		...
		<div class="wdu-pops-search wdu-hidden wdu-conceal wdu-anim wdu-anim-upbit" id="wdu-pops-search">
			<div class="wdu-pops-case wdu-back-ashen wdu-box-shadow">
				...
				<div class="wdu-pops-box">
					...
					<div class="wdu-pops-hot">
						...
						<ul class="wdu-pops-list wdu-back-whits wdu-part-rows">
							<li class="wdu-col-xs6"><a class="wdu-event wdu-part-eone" href="/index.php/vod/search/wd/%E5%8F%98%E5%BD%A2%E9%87%91%E5%88%9A.html"><span class="wdu-part-nums wdu-part-num1">1</span><span class="wdu-name">变形金刚</span></a></li>
							<li class="wdu-col-xs6"><a class="wdu-event wdu-part-eone" href="/index.php/vod/search/wd/%E7%81%AB%E5%BD%B1%E5%BF%8D%E8%80%85.html"><span class="wdu-part-nums wdu-part-num2">2</span><span class="wdu-name">火影忍者</span></a></li>
							<li class="wdu-col-xs6"><a class="wdu-event wdu-part-eone" href="/index.php/vod/search/wd/%E5%A4%8D%E4%BB%87%E8%80%85%E8%81%94%E7%9B%9F.html"><span class="wdu-part-nums wdu-part-num3">3</span><span class="wdu-name">复仇者联盟</span></a></li>
							<li class="wdu-col-xs6"><a class="wdu-event wdu-part-eone" href="/index.php/vod/search/wd/%E6%88%98%E7%8B%BC.html"><span class="wdu-part-nums wdu-part-num4">4</span><span class="wdu-name">战狼</span></a></li>
							<li class="wdu-col-xs6"><a class="wdu-event wdu-part-eone" href="/index.php/vod/search/wd/%E7%BA%A2%E6%B5%B7%E8%A1%8C%E5%8A%A8.html"><span class="wdu-part-nums wdu-part-num5">5</span><span class="wdu-name">红海行动</span></a></li>
							<li class="wdu-col-xs6"><a class="wdu-event wdu-part-eone" href="/index.php/vod/search/wd/%E4%B8%9C%E4%BA%AC%E9%A3%9F%E5%B0%B8%E9%AC%BC.html"><span class="wdu-part-nums wdu-part-num6">6</span><span class="wdu-name">东京食尸鬼</span></a></li>
						</ul>
					</div>
				</div>
			</div>
		</div>
		<div class="wdu-pops-record wdu-box-shadow wdu-hidden wdu-conceal wdu-anim wdu-anim-upbit" id="wdu-pops-record">
