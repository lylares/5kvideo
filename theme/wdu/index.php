...
<div class="wdu-main-info wdu-min-width">
	<div class="wdu-part-case">
      ...
      $api = "http://www.yinyuetai.com/mv/get-first-video?area=all&size=32";
...
// 
$name = '360_index_'.md5('https://www.360kan.com/');
...
$indexcontent = gzinflate(file_get_contents($file)); 
...
if(!is_file($file))
{
	...
	$tvData = file_get_contents($m1905);
...
$m1905 = gzinflate(file_get_contents($file)); 
            ...
            echo '
			            <li class="wdu-list-item wdu-padding wdu-col-xs6 wdu-col-sm3 wdu-col-md2">
							<a class="wdu-list-pics wdu-lazy wdu-part-2by3 wdu-wide lazyload"  target="'.$urt.'" href="dplay/3_'.$tid[1][$i].'.html" title="'.$tid[2][$i].'" data-original="'.$timg[2][$i].'">
							    <span class="wdu-list-play wdu-hide-xs"></span>
...
$ptcontent = gzinflate(file_get_contents($file)); 
		...
		<div class="wdu-part-layout wdu-back-whits">
			...
			<ul class="wdu-list-info wdu-list-img wdu-part-rows">
				...
				<a class="wdu-list-pics wdu-lazy wdu-part-16by9 lazyload" target="_blank" href="https://www.lylares.com/sesme-co.html" data-original="https://tva2.sinaimg.cn/large/bfe05ea9ly1fxwdxs2v7lj20kx0b4108.jpg">
				...
				<li class="wdu-list-item wdu-padding wdu-col-xs6 wdu-col-sm4 wdu-col-md3">
                  <a target="_blank" class="wdu-list-pics wdu-lazy wdu-part-16by9 lazyload" href="https://www.lylares.com/a-api-for-get-tv-album-list.html" data-original="https://tva2.sinaimg.cn/large/bfe05ea9gy1fr21fjnjtnj20m80etq41.jpg">
				...
				<li class="wdu-list-item wdu-padding wdu-col-xs6 wdu-col-sm4 wdu-col-md3">
                  <a target="_blank" class="wdu-list-pics wdu-lazy wdu-part-16by9 lazyload" href="https://www.lylares.com/php-code-of-aikan-wallpaper-website.html" data-original="https://tva2.sinaimg.cn/large/bfe05ea9ly1fx6msdrg8zj21kw0rcb2a.jpg">
                    <span class="wdu-list-play wdu-list-arts wdu-hide-xs"></span>
				...
				<li class="wdu-list-item wdu-padding wdu-col-xs6 wdu-col-sm4 wdu-col-md3 wdu-hide-sm wdu-show-md-block">
                  <a target="_blank" class="wdu-list-pics wdu-lazy wdu-part-16by9 lazyload" href="https://doc.berryapi.net/v2/" data-original="https://tva2.sinaimg.cn/large/bfe05ea9ly1fvoat38809j20m80dc76y.jpg">
                    <span class="wdu-list-play wdu-list-arts wdu-hide-xs"></span>
...
$vaindexcontent = gzinflate(file_get_contents($file)); 
				...
				<div class="wdu-swip-container  wdu-part-rows">
					...
					echo'
					    <li class="swiper-slide wdu-swip-slide">
					        <a href="play/'.$vaslider[$i]['id'].'.html'.'" class="wdu-list-pics wdu-part-3by2 wdu-swip-lazy" style="background:url('.$vaslider[$i]['cover'].')">
...
$ctindexcontent = gzinflate(file_get_contents($file)); 
