		...
		return _inherits(b, a), _createClass(b, null, [{
			...
			value: function() {
				this.prototype.Emitter = Emitter, this.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "addedfiles", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], this.prototype.defaultOptions = {
					...
					renameFile: null,
					forceFallback: !1,
					dictDefaultMessage: "拖动图片于此上传",
					dictFallbackMessage: "你的浏览器不支持拖动上传",
					dictFallbackText: "Please use the fallback form below to upload your files like in the olden days.",
					dictFileTooBig: "文件太大 ({{filesize}}MiB). 支持最大上传: {{maxFilesize}}MiB.",
					dictInvalidFileType: "不支持此类型的文件上传",
					dictResponseError: "服务器返回 {{statusCode}}",
					dictCancelUpload: "取消上传",
					dictUploadCanceled: "上传取消",
					dictCancelUploadConfirmation: "你确定要取消上传 ?",
					dictRemoveFile: "移除图片",
					dictRemoveFileConfirmation: null,
					dictMaxFilesExceeded: "不能继续添加图片",
					dictFileSizeUnits: {
						tb: "TB",
						gb: "GB",
						mb: "MB",
					...
					success: function(a) {
						var callback = a.xhr.response;
						var obj = eval("("+callback+")");
						if(obj.code=='10001')
						{
							var weburl = document.getElementById("img-get");weburl.value='https://www.5kvideo.cc'+obj.data.local_imgurl;
						}
			...
			value: function(a) {
				...
				this._transformFiles(a, function(d) {
					if (a[0].upload.chunked) {
						...
						}, c.options.parallelChunkUploads) for (var i = 0; i < e.upload.totalChunkCount; i++) h();
						else h()
					} else {
