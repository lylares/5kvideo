            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">话题管理</li>
                </ol>
              </nav>
            </div>
      ...
      <div class="card mb-4">
		...
		<form id="post-content" >
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label class="form-control-label" for="alias">别名</label>
                <input class="form-control" id="alias" name="alias" type="text" placeholder="别名" required>
              </div>
            </div>
          ...
          <table class="table align-items-center table-flush table-striped">
			...
			<?php
              ...
              <tr>
				...
				<td>
                  <span class="text-muted"><a href="<?php echo $row['alias'].'.html';?>" target="_blank"><?php echo $row['alias'].'.html';?></a></span>
                </td>
				<td>
    ...
    return new Promise(function(resolve, reject) {
      setTimeout(function() {
          ...
          resolve(
		 	...
		 	$.ajax({
			type: "POST",
			url: _wudu_info.domain+"Adm/del/topic",
...
$.ajax({
			type: "POST",
			url: _wudu_info.domain+"Adm/update/topicStatus",
			contentType: "application/x-www-form-urlencoded; charset=utf-8",
			dataTpye: 'json',
...
$.ajax({
			type: "POST",
			url: _wudu_info.domain+"Adm/add/topic",
			contentType:false,
			dataTpye: 'json',
			data: form,
			processData:false,
