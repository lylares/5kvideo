...
$row=$db->getRow($sql);
$imgent ='https://images.weserv.nl/?url=';
$movie="";
$tv="";
$dm="";
$zy="";
...
//
$wudu_smtp = $row['smtp'];
$wudu_smtp_port = $row['smtp_port'];

$wudu_smtp_user = $row['smtp_user'];

$wudu_smtp_pwd = $row['smtp_pwd'];

//广告获取
function get_ad($t){
	$sql = 'select * from wudu_ad where catid ='.$t.'';
