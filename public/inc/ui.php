...
<meta name="author" content="雾都TV,admin@5kvideo.cc">
...
<script> 
window.globalConfig = {
	 siteUrl: "<?php echo $wudu_domain;?>",
     apiHost:"<?php echo $wudu_domain;?>api/v1/",
	 single:"0",
...
window.globalConfig.api= {
		userReg: window.globalConfig.apiHost + 'user/reg',
		userAccountActive: window.globalConfig.apiHost + 'user/activate',
		userlogin: window.globalConfig.apiHost +'user/login',
		userloginOut: window.globalConfig.apiHost + 'user/loginout',
		userSwitchSource : window.globalConfig.apiHost + 'switch/source',
		userDeleteHistory : window.globalConfig.apiHost + 'del/history',
		getUserInfomation: window.globalConfig.apiHost + 'get/user',
		getThemeDemo : window.globalConfig.apiHost + 'get/themeDemo',
		getPlayinfomation: window.globalConfig.apiHost + 'get/playinfo',
		getHotlistquery : "https://www.360kan.com/hotlistquery",
		getTvlist :"https://api.berryapi.net/?s=Parse/Tvlist",
        getQrcode:"https://api.berryapi.net/?service=QrCode.Png&size=5&data=",
        errorReport:window.globalConfig.apiHost + 'update/errorReport',
        getUserComments:window.globalConfig.apiHost + 'get/UserComments',
		publicAppKey :'',
	 }
window.globalConfig.shareContent = {
     title:"",
	 url: window.globalConfig.currentPage,
	 poster:''
}
...
<div class="wdu-colo-info wdu-part-layout wdu-part-rows wdu-back-whits wdu-event wdu-hidden">
	<a class="wdu-padding wdu-colo-black wdu-theme-change" data-type="black" href="javascript:;">暗夜黑</a>
	<a class="wdu-padding wdu-colo-golds wdu-theme-change" data-type="golds" href="javascript:;">暗夜金</a>
	...
	<a class="wdu-padding wdu-colo-orang wdu-theme-change" data-type="orang" href="javascript:;">果粒橙</a>
	<a class="wdu-padding wdu-colo-blues wdu-theme-change" data-type="blues"  href="javascript:;">天空蓝</a>
	<a class="wdu-padding wdu-colo-white wdu-theme-change" data-type="green"  href="javascript:;">宝强绿</a>
	<a class="wdu-padding wdu-colo-pinks wdu-theme-change" data-type="pinks"  href="javascript:;">少女粉</a>
</div>
...
<div class="wdu-foot-info wdu-part-layout wdu-back-whits">
	<div class="wdu-part-case">
		...
		<p class="wdu-text-center wdu-text-black">
          雾都TV不存储资源，视频播放接口由第三方提供，内容由程序自动抓取自网络，侵权投诉:admin#5kvideo.cc</br>
		  &copy;&nbsp;<?php echo date('Y');?>&nbsp;<a href="https://www.5kvideo.cc">雾都TV</a> All RIGHTS RESERVED.</br>
		  						<a href="http://www.beian.miit.gov.cn/" target="_blank" rel="nofollow">渝ICP备17005042号</a>
...
$(function() {
  $.ajax({
			type: "GET",
			url: window.globalConfig.api.getUserInfomation,
  ...
  $(".qrcode-share-img").attr("src",window.globalConfig.api.getQrcode + window.globalConfig.currentPage);
})
