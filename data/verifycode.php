<?php
	class Imagecode{
		...
		private $fonturl;
		private $session;
		function __construct($width = 120,$height = 30,$counts = 5,$distrubcode="1235467890qwertyuipkjhgfdaszxcvbnm",$fonturl="./simkai.ttf"){
			$this->width=$width;
			$this->height=$height;
			$this->counts=$counts;
			...
			session_start();
			$_SESSION['varifycode']=$this->session;
		}
		...
		private function set_code($im){
				...
				$fontsize=rand(30,35);
				$fonturl="./simkai.ttf";//$this->fonturl;
